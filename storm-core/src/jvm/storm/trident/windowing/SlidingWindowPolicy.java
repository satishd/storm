...
public class SlidingWindowPolicy extends WindowPolicy {
    ...
    private final BaseWindowedBolt.Duration slidingInterval;

    public SlidingWindowPolicy(BaseWindowedBolt.Duration windowDuration, BaseWindowedBolt.Duration slidingInterval) {
